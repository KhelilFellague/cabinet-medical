...
public class Login extends JFrame {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("New label");
			...
			lblNewLabel.setIcon(new ImageIcon(Login.class.getResource("/Assets/docteur.png")));
			...
			public void actionPerformed(ActionEvent e) {
				...
				//sinon
					...
					try {
						...
						if(medecin != null) {	
						MedecinPage med = new MedecinPage(medecin);
						...
						getFrame().dispose();
							...
							if(secretaire != null) {
								SecretairePage sec = new SecretairePage(secretaire); 
								sec.setVisible(true);
							//	sec.setExtendedState(JFrame.MAXIMIZED_BOTH);
								//sec.setUndecorated(true);
						...
						System.out.println("ERREUR DE CONNEXION login "+ ex);
